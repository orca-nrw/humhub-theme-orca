    ...
    <a href="<?= $space->getUrl(); ?>">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <div data-message-count="<?= $updateCount; ?>" <?= ($updateCount > 0) ? '' : 'style="display:none"' ?> class="badge badge-space messageCount pull-right tt" title="<?= Yii::t('SpaceModule.chooser', '{n,plural,=1{# new entry} other{# new entries}} since your last visit', ['n' => $updateCount]); ?>">
                    <?= $updateCount; ?>
                </div>
                <br>
